<?php session_start();
$_SESSION['current_page'] = 'inicio'; include "head.php";?>
    ...
    <div class="contenedor-general" >
        <div class="row" style="margin: 0px;">        
            ...
            <div style="display: flex; justify-content: space-between; border-bottom: 1px solid #ebebeb;padding-bottom: 15px;">
                <h5 style="margin-bottom: 20px;position: relative;top: 10px;">Usuarios</h5>
                <a  href="#" onclick="irANuevo()" class="btn btn-primary">Nuevo</a>
            </div>
            <!-- <div style="display: flex; justify-content: space-between; border-bottom: 1px solid #ebebeb;padding-bottom: 15px;">                
